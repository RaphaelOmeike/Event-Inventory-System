...
namespace Application.Helpers
{
    ...
    {
        public static PagedResponse<IEnumerable<T>> CreatePagedResponse<T>(List<T> pagedData, PaginationFilter validFilter, int totalRecords, IUriService uriService, string route)
        {
